...
bool is_target_alloc_site(unsigned long curr_ip) {
	unsigned long alloc_site_array[ALLOCNUM] = {
        // for barametal
        0xffffffff81bdf799, // sctp_auth_init_hmacs net/sctp/auth.c:464
        0xffffffff81bbb986, // sctp_endpoint_new net/sctp/endpointola.c:134
        // + bug-kobject_add_internal, cumulative overhead
        // 0xffffffff81b4c788, // hci_conn_add net/bluetooth/hci_conn.c:525
